/*
  ...
  2. Security
    ...
    - Add policy for authenticated users to insert customer data
*/
...
-- Create policy to allow authenticated users to update their own customer data
CREATE POLICY "Allow authenticated users to update their own customers"
  ON customers
  FOR UPDATE
  TO authenticated
